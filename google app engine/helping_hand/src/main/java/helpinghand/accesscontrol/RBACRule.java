...
public enum RBACRule {
	...
	DELETE_USER("DELETE_user", new Role[] {USER,GBO,SYSADMIN}), //delete a user account
	...
	DELETE_INSTITUTION("DELETE_institution", new Role[] {INSTITUTION,GBO,SYSADMIN}), // delete an institution account
	...
	UPDATE_INSTITUTION_AVATAR("PUT_institution_avatar", new Role[] {INSTITUTION,GBO,SYSADMIN}), // update a user's avatar
	...
	//EmailLinksResource
	CONFIRM_EMAIL_UPDATE("GET_links_email",new Role[] {ALL}),
	CONFIRM_ACCOUNT_CREATION("GET_links_account",new Role[] {ALL}),
